...
class UnionTree {
	...
	void internalSearch(QueryResult*, FingerprintTanimoto*, int64_t, int, S);
	// recursively search sub tree by hamming distance
	void internalSearch(QueryResult*, FingerprintHamming*, int64_t, int, S);

	public:

	// constructor
	// create a new UnionTree from an array of Fingerprints
...
template <>
void UnionTree<FingerprintTanimoto>::internalSearch(QueryResult *result, FingerprintTanimoto *queryPrint, int64_t node, int AB, float minTanimoto) {	
...
template <>
void UnionTree<FingerprintHamming>::internalSearch(QueryResult *result, FingerprintHamming *queryPrint, int64_t node, int AB, int maxHamming) {	
	int AiU = queryPrint->intersectCard(mUnion[node]);
...
template <>
inline void UnionTree<FingerprintTanimoto>::search(QueryResult *result, FingerprintTanimoto *queryPrint, int cardinality, float minTanimotoSimilarity) {
...
template <>
inline void UnionTree<FingerprintHamming>::search(QueryResult *result, FingerprintHamming *queryPrint, int cardinality, int maxHammingDistance) {
